...
function emitRouterClass(className, style = DEFAULT_COMMENT_STYLE) {
...
function emitRouterFile(candidate, options) {
...
export function emitNameEnrichmentHelper({ targetTable }, options = {}) {
    const names = csharpNames(options);
