...
public sealed class SqliteStandardRepository : SqliteCrudRepository, IStandardCrudRepository
{
    public SqliteStandardRepository(SqliteDatasource datasource, string tableName)
